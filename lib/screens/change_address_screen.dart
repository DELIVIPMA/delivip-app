...
class _ChangeAddressScreenState extends State<ChangeAddressScreen> {
  ...
  List<_RecentAddress> _recentAddresses = [
    _RecentAddress(name: 'Agadir Marina', city: 'Agadir, Maroc', isSelected: true),
    _RecentAddress(name: 'Hay Mohammadi', city: 'Agadir, Maroc', isSelected: false),
  ];
  ...
  Future<void> _searchWithNominatim(String query) async {
    ...
    if (response.statusCode == 200) {
      ...
      if (mounted) {
        setState(() {
          _suggestions = data.map((item) => _SearchSuggestion(
    ...
    try {
      ...
      if (permission == LocationPermission.deniedForever) {
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Permission de localisation refusée définitivement. Modifiez les paramètres.'),
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          const Icon(Icons.my_location, size: 14, color: Color(0xFF00BFA5)),
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    const Divider(height: 1, thickness: 1, indent: 16, endIndent: 16, color: Color(0xFFF0F1F3)),
                    ...
                    // Recent Address List
                    ..._recentAddresses.asMap().entries.map((entry) => _RecentAddressRow(
                      address: entry.value,
        ...
        Container(
          ...
          child: Row(
            children: [
              GestureDetector(
                onTap: onTap,
                child: const Icon(Icons.location_on_outlined, size: 22, color: Colors.black),
              ),
              const SizedBox(width: 14),
              Expanded(
