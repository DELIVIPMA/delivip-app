...
class SearchCategoriesScreen extends StatelessWidget {
  ...
  static const List<_CategoryItem> _topCategories = [
    _CategoryItem(emoji: '\u{1F373}', name: 'Petit-d\u00E9jeuner & Brunch', bg: Color(0xFF1A1A1A)),
    _CategoryItem(emoji: '\u2615', name: 'Caf\u00E9 & Th\u00E9', bg: Color(0xFF8B0000)),
    _CategoryItem(
      emoji: '\u{1F48E}',
      name: 'Offres',
    ...
    _CategoryItem(emoji: '\u2B50', name: 'R\u00E9compenses', bg: Color(0xFF2E7D32)),
    _CategoryItem(emoji: '\u{1F3C6}', name: 'Meilleur rapport qualit\u00E9', bg: Color(0xFFFFF8E1)),
    _CategoryItem(emoji: '\u2708\uFE0F', name: 'Livraison gratuite', bg: Color(0xFFFFFDE7)),
  ];
  ...
  static const List<_CategoryItem> _allCategories = [
    ...
    _CategoryItem(emoji: '\u{1F950}', name: 'Boulangerie', bg: Color(0xFFF9A825)),
    _CategoryItem(emoji: '\u{1F96A}', name: 'Sandwich', bg: Color(0xFF00796B)),
    _CategoryItem(emoji: '\u{1F363}', name: 'Sushi', bg: Color(0xFFC62828)),
    _CategoryItem(emoji: '\u{1F356}', name: 'Cor\u00E9en', bg: Color(0xFF212121)),
    _CategoryItem(emoji: '\u{1F372}', name: 'Vietnamien', bg: Color(0xFFE53935)),
    _CategoryItem(emoji: '\u{1F331}', name: 'Vegan', bg: Color(0xFF66BB6A)),
    _CategoryItem(emoji: '\u{1F9CB}', name: 'Bubble Tea', bg: Color(0xFF7B1FA2)),
    _CategoryItem(
      emoji: '\u{1F964}',
      name: 'Jus & Smoothies',
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildSectionTitle('Toutes les cat\u00E9gories', topMargin: 20),
  ...
  // ═══════════════════ CATEGORY CARD ═════════════════════════════
  Widget _buildCategoryCard(_CategoryItem item, {bool shadow = false, bool border = false}) {
    return Container(
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(14),
        border: border ? Border.all(color: const Color(0xFFF0F0F0), width: 1) : null,
        boxShadow: shadow
            ? [
                BoxShadow(
