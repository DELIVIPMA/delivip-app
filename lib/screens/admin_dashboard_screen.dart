...
class AdminDashboardScreenState extends State<AdminDashboardScreen> {
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                Text(_isDark ? 'Mode sombre' : 'Mode clair', style: GoogleFonts.inter(fontSize: 12, color: context.adminTextMuted)),
                const Spacer(),
                GestureDetector(
                  onTap: _toggleTheme,
            ...
            child: Row(
              children: [
                ...
                Column(
                  ...
                  children: [
                    Text('Admin', style: GoogleFonts.inter(fontSize: 13, fontWeight: FontWeight.w600, color: context.adminTextPrimary)),
                    Text('Super Admin', style: GoogleFonts.inter(fontSize: 11, color: context.adminGreyText)),
                  ],
                ),
                const Spacer(),
  ...
  Widget _buildTopBar(BuildContext context) {
    final titles = ['Dashboard', 'Gestion des Stores', 'Gestion des Commandes', 'Clients', 'Catégories', 'Paramètres'];
    return Container(
      height: 64,
      ...
      child: Row(
        children: [
          ...
          if (_selectedIndex == 0) ...[
            ...
            const SizedBox(width: 12),
            _badge(context, _orders.where((o) => o.status == 'pending' || o.status == 'preparing').length.toString(), 'Actives', isAlert: true),
          ],
          const Spacer(),
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            runSpacing: 16,
            children: [
              _StatCardGradient(title: 'Total Commandes', value: '${_orders.length}', gradientColors: const [Color(0xFF2C0A0E), Color(0xFF4A151B)], icon: Icons.receipt_long),
              _StatCardGradient(title: 'Revenus', value: '${totalRevenue.toStringAsFixed(0)} DH', gradientColors: const [Color(0xFFFF9800), Color(0xFFF57C00)], icon: Icons.trending_up),
              _StatCardGradient(title: 'Commandes Actives', value: '$activeOrders', gradientColors: const [Color(0xFFE64A19), Color(0xFFD84315)], icon: Icons.delivery_dining),
              _StatCardGradient(title: 'Clients', value: '$totalCustomers', gradientColors: const [Color(0xFF4CAF50), Color(0xFF388E3C)], icon: Icons.people),
            ],
          ),
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          Text('Aperçu des revenus', style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.bold, color: context.adminTextPrimary)),
                          Container(
                            padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
              ...
              Expanded(
                ...
                child: Container(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Dernières commandes', style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.bold, color: context.adminTextPrimary)),
                      const SizedBox(height: 12),
                      Expanded(
                        child: ListView.separated(
                          itemCount: _orders.take(5).length,
                          separatorBuilder: (_, __) => Divider(height: 1, color: context.adminDivider),
                          itemBuilder: (_, i) {
                            final o = _orders[i];
                            return ListTile(
                              dense: true,
                              ...
                              subtitle: Text('${o.total.toStringAsFixed(0)} DH', style: GoogleFonts.inter(fontSize: 11, color: context.adminGreyText)),
                              trailing: Container(
          ...
          // Stores Overview
          Text('Aperçu des stores', style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.bold, color: context.adminTextPrimary)),
          const SizedBox(height: 12),
              ...
              children: [
                ClipRRect(
                  ...
                  child: s.imageUrl.isNotEmpty
                      ? Image.network(s.imageUrl, width: 40, height: 40, fit: BoxFit.cover, errorBuilder: (_, __, ___) => Container(width: 40, height: 40, color: Colors.grey.shade200, child: const Icon(Icons.store, color: Colors.grey)))
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('${s.products.length} produits • ${s.category}', style: GoogleFonts.inter(fontSize: 11, color: context.adminGreyText)),
                    ],
                  ),
                ),
                Container(
                  ...
                  child: Text(s.isActive ? 'Actif' : 'Inactif', style: GoogleFonts.inter(fontSize: 10, fontWeight: FontWeight.w600, color: s.isActive ? const Color(0xFF2E7D32) : Colors.red)),
                ),
              ],
            ),
          )),
                ...
                children: [
                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          _tabBtn(context, '📋 Liste (${widget.stores.length})', 0),
                ...
                Row(
                  children: [
                    ...
                    SizedBox(
                      height: 32,
                      child: FilterChip(
                        label: Text('Inactifs', style: GoogleFonts.inter(fontSize: 11, color: context.adminTextPrimary)),
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            Text('Aucun store trouvé', style: GoogleFonts.poppins(fontSize: 16, color: context.adminGreyText)),
            const SizedBox(height: 8),
            ElevatedButton(
              ...
              children: [
                ClipRRect(
                  ...
                  child: store.imageUrl.isNotEmpty
                      ? Image.network(store.imageUrl, width: 48, height: 48, fit: BoxFit.cover, errorBuilder: (_, __, ___) => Container(width: 48, height: 48, color: Colors.white24, child: Text(store.emoji, style: const TextStyle(fontSize: 24), textAlign: TextAlign.center)))
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('${store.products.length} produits • ${store.category}', style: GoogleFonts.inter(fontSize: 12, color: Colors.white70)),
                    ],
                  ),
                ),
                Container(
                  ...
                  child: Text(store.isActive ? 'Actif' : 'Inactif', style: GoogleFonts.inter(fontSize: 11, fontWeight: FontWeight.w600, color: Colors.white)),
                ),
              ],
            ),
          ),
                ...
                ...store.products.map((p) => Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text('${p.price.toStringAsFixed(0)} DH', style: GoogleFonts.inter(fontSize: 13, fontWeight: FontWeight.w700, color: DeliVipColors.teal)),
                      const SizedBox(width: 8),
                  ...
                  children: [
                    ...
                    Expanded(
                      child: OutlinedButton.icon(
                        ...
                        label: Text('Supprimer', style: GoogleFonts.inter(fontSize: 12, color: Colors.red)),
  ...
  void _deleteStore(BuildContext context, AdminStore store) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        backgroundColor: context.adminCard,
        title: Text('Supprimer le store ?', style: TextStyle(color: context.adminTextPrimary)),
        content: Text('Voulez-vous supprimer "${store.name}" ? Cette action est irréversible.', style: TextStyle(color: context.adminTextSecondary)),
        actions: [
          TextButton(onPressed: () => Navigator.pop(ctx), child: Text('Annuler', style: TextStyle(color: context.adminTextSecondary))),
...
class _StoreFormState extends State<_StoreForm> {
  ...
  void dispose() {
    ...
    _latCtrl.dispose();
    _lngCtrl.dispose();
    for (var c in [..._pNames, ..._pDescs, ..._pPrices]) c.dispose();
    super.dispose();
  }
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Text(_isEditing ? '✏️ Modifier' : '➕ Nouveau Store', style: GoogleFonts.poppins(fontSize: 20, fontWeight: FontWeight.w700, color: context.adminTextPrimary)),
              const Spacer(),
          ...
          Row(
            children: [
              Expanded(flex: 3, child: _field(context, 'Nom du store', _nameCtrl, Icons.store)),
              const SizedBox(width: 12),
              Expanded(flex: 1, child: _field(context, 'Emoji (fallback)', _emojiCtrl, Icons.emoji_emotions)),
            ],
          ),
          const SizedBox(height: 12),
          _field(context, 'Image URL (lien vers image)', _imageUrlCtrl, Icons.image),
          const SizedBox(height: 12),
          // Preview
          if (_imageUrlCtrl.text.isNotEmpty)
            Container(
              ...
              child: ClipRRect(
                borderRadius: BorderRadius.circular(12),
                child: Image.network(_imageUrlCtrl.text, width: 80, height: 80, fit: BoxFit.cover, errorBuilder: (_, __, ___) => Container(color: Colors.grey.shade200, child: Icon(Icons.broken_image, color: Colors.grey.shade400))),
              ),
            ),
          const SizedBox(height: 12),
          _field(context, 'Description', _descCtrl, Icons.description, maxLines: 3),
          const SizedBox(height: 12),
          _field(context, 'Adresse', _addressCtrl, Icons.location_on),
          const SizedBox(height: 12),
          Row(
            children: [
              Expanded(child: _field(context, 'Téléphone', _phoneCtrl, Icons.phone)),
              const SizedBox(width: 12),
              Expanded(child: _field(context, 'Ouverture', _openCtrl, Icons.wb_sunny)),
            ],
          ),
          const SizedBox(height: 12),
          Row(
            children: [
              Expanded(child: _field(context, 'Fermeture', _closeCtrl, Icons.nightlight)),
              const SizedBox(width: 12),
              Expanded(child: _field(context, 'Latitude', _latCtrl, Icons.map)),
              const SizedBox(width: 12),
              Expanded(child: _field(context, 'Longitude', _lngCtrl, Icons.map)),
            ],
          ),
          const SizedBox(height: 12),
          // Active toggle
          Container(
            ...
            child: Row(
              children: [
                ...
                const SizedBox(width: 8),
                Text('Store actif', style: GoogleFonts.inter(fontSize: 14, color: context.adminTextPrimary)),
                const Spacer(),
                Switch(value: _store.isActive, activeColor: DeliVipColors.teal, onChanged: (v) => setState(() => _store.isActive = v)),
              ],
            ),
          ),
          const SizedBox(height: 20),
          // Products
          Text('Produits (${_store.products.length})', style: GoogleFonts.poppins(fontSize: 15, fontWeight: FontWeight.w600, color: context.adminTextPrimary)),
          const SizedBox(height: 8),
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: Text(_isEditing ? '💾 Enregistrer' : '✅ Ajouter le store', style: GoogleFonts.inter(fontSize: 15, fontWeight: FontWeight.w600)),
            ),
          ),
    ...
    return Container(
      ...
      child: Column(
        children: [
          Row(
            children: [
              Text('Produit #${i + 1}', style: GoogleFonts.inter(fontSize: 12, fontWeight: FontWeight.w600, color: DeliVipColors.teal)),
              const Spacer(),
              GestureDetector(
                onTap: () => setState(() {
...
class _OrdersPanelState extends State<_OrdersPanel> {
  ...
  Widget build(BuildContext context) {
    ...
    final filterLabels = ['Tous', 'En attente', 'Préparation', 'Prête', 'Livraison', 'Livrée', 'Annulée'];
    ...
    return Column(
      children: [
        ...
        Padding(
          ...
          child: Row(
            children: [
              _miniStat(context, 'Total', '${widget.orders.length}', DeliVipColors.teal),
              const SizedBox(width: 16),
              _miniStat(context, 'En cours', '${widget.orders.where((o) => o.status == 'pending' || o.status == 'preparing').length}', Colors.orange),
              const SizedBox(width: 16),
              _miniStat(context, 'Livrées', '${widget.orders.where((o) => o.status == 'delivered').length}', const Color(0xFF4CAF50)),
              const SizedBox(width: 16),
              _miniStat(context, 'Annulées', '${widget.orders.where((o) => o.status == 'cancelled').length}', Colors.red),
            ],
          ),
        ),
        const SizedBox(height: 12),
    ...
    if (list.isEmpty) {
      return Center(child: Column(
        ...
        children: [
          const Text('📋', style: TextStyle(fontSize: 48)),
          const SizedBox(height: 8),
          Text('Aucune commande', style: GoogleFonts.poppins(fontSize: 16, color: context.adminGreyText)),
        ],
      ));
    }
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text('${order.total.toStringAsFixed(0)} DH • ${order.items.length} article(s)', style: GoogleFonts.inter(fontSize: 12, fontWeight: FontWeight.w600, color: context.adminTextPrimary)),
          ...
          PopupMenuButton<String>(
            ...
            itemBuilder: (_) => [
              ...
              const PopupMenuItem(value: 'delivering', child: Text('🚚 En livraison')),
        ...
        Padding(
          ...
          child: Row(
            children: [
              ...
              const SizedBox(width: 12),
              _badge(context, '${sampleCustomers.fold(0, (sum, c) => sum + (c['orders'] as int))}', 'Commandes total'),
              const SizedBox(width: 12),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Text('${c['orders']} commandes', style: GoogleFonts.inter(fontSize: 11, color: context.adminGreyText)),
                              const SizedBox(width: 8),
  ...
  void _addCategory(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
        backgroundColor: context.adminCard,
        title: Text('Nouvelle catégorie', style: TextStyle(color: context.adminTextPrimary)),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            TextField(
        ...
        actions: [
          ...
          TextButton(onPressed: () {
            ...
            Navigator.pop(ctx);
          }, child: const Text('Ajouter', style: TextStyle(color: DeliVipColors.teal))),
        ],
      ),
    );
  }
  ...
  void _editCategory(BuildContext context, AdminCategory cat) {
    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
        backgroundColor: context.adminCard,
        title: Text('Modifier catégorie', style: TextStyle(color: context.adminTextPrimary)),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            TextField(
        ...
        actions: [
          ...
          TextButton(onPressed: () {
            ...
            Navigator.pop(ctx);
          }, child: const Text('Enregistrer', style: TextStyle(color: DeliVipColors.teal))),
        ],
      ),
    );
  }
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      const SizedBox(width: 12),
                      Text('${widget.categories.length} catégories', style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.w600, color: context.adminTextPrimary)),
                    ],
                  ),
                ),
              ),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('Ordre: ${cat.displayOrder}', style: GoogleFonts.inter(fontSize: 11, color: context.adminGreyText)),
                        ],
                      ),
                    ),
                    Switch(
                      value: cat.isActive,
                      activeColor: DeliVipColors.teal,
                      onChanged: (v) {
                        cat.isActive = v;
                        widget.onUpdate(widget.categories);
                      },
...
class _SettingsPanelState extends State<_SettingsPanel> {
  ...
  @override
  void dispose() {
    for (var c in [_nameCtrl, _phoneCtrl, _emailCtrl, _feeCtrl, _minCtrl, _freeCtrl]) c.dispose();
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('Paramètres de l\'application', style: GoogleFonts.poppins(fontSize: 20, fontWeight: FontWeight.bold, color: context.adminTextPrimary)),
          const SizedBox(height: 8),
          Text('Contrôlez le comportement de l\'app client DeliVip', style: GoogleFonts.inter(fontSize: 13, color: context.adminGreyText)),
          const SizedBox(height: 24),
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                const SizedBox(width: 12),
                Text('Mode sombre', style: GoogleFonts.inter(fontSize: 14, color: context.adminTextPrimary)),
                const Spacer(),
                Switch(
          ...
          const SizedBox(height: 12),
          _settingField(context, 'Frais de livraison (DH)', _feeCtrl, isNumber: true),
          const SizedBox(height: 12),
          _settingField(context, 'Minimum commande (DH)', _minCtrl, isNumber: true),
          const SizedBox(height: 12),
          _settingField(context, 'Livraison gratuite à partir de (DH)', _freeCtrl, isNumber: true),
          const SizedBox(height: 24),

          // Section: Fonctionnalités
          _sectionTitle(context, '⚙️ Fonctionnalités'),
          const SizedBox(height: 12),
          _toggleOption(context, 'Activer le "Pickup"', s.enablePickup, (v) => setState(() => s.enablePickup = v)),
          _toggleOption(context, 'Activer le "Dine In"', s.enableDineIn, (v) => setState(() => s.enableDineIn = v)),
          _toggleOption(context, 'Activer l\'Épicerie', s.enableGrocery, (v) => setState(() => s.enableGrocery = v)),
          _toggleOption(context, 'Activer les Promotions', s.enablePromotions, (v) => setState(() => s.enablePromotions = v)),
          const SizedBox(height: 24),
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              onPressed: () {
                ...
                s.freeDeliveryThreshold = double.tryParse(_freeCtrl.text) ?? 100.0;
                widget.onUpdate(s);
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Switch(value: value, activeColor: DeliVipColors.teal, onChanged: onChange),
        ],
      ),
    );
  }
