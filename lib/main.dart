...
class _BottomNav extends StatelessWidget {
  ...
  final int cartCount;
  const _BottomNav({required this.currentIndex, required this.onTap, required this.cartCount});
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border(top: BorderSide(color: DeliVipColors.border.withValues(alpha: 0.7))),
      ),
      child: SafeArea(
        child: Padding(
...
class _NavItem extends StatelessWidget {
  ...
  const _NavItem({required this.icon, required this.label, required this.isSelected, this.badge, required this.onTap});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: isSelected ? DeliVipColors.teal.withValues(alpha: 0.1) : Colors.transparent,
          borderRadius: BorderRadius.circular(16),
        ),
        child: Column(
          ...
          children: [
            Stack(
              ...
              children: [
                Icon(icon, size: 22, color: isSelected ? DeliVipColors.teal : DeliVipColors.textMuted),
                if (badge != null)
                  Positioned(
                    right: -8, top: -6,
                    child: Container(
            ...
            Text(label, style: GoogleFonts.inter(fontSize: 10, fontWeight: isSelected ? FontWeight.w600 : FontWeight.w400, color: isSelected ? DeliVipColors.teal : DeliVipColors.textMuted)),
          ],
        ),
      ),
    );
