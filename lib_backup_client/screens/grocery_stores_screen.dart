...
class GroceryStoresScreen extends StatelessWidget {
  ...
  static const _stores = [
    _Store(
      'Marjane',
      '\u{1F3EA}',
      'https://picsum.photos/seed/marjane/400/200',
      Color(0xFFC8102E),
      'En 60 minutes',
      false,
    ),
    _Store(
      'Carrefour',
      '\u{1F6D2}',
      'https://picsum.photos/seed/carrefour/400/200',
      Color(0xFF2E7D32),
      'En 60 minutes',
      false,
    ),
    _Store(
      "Label'Vie",
      '\u{1F3EC}',
      'https://picsum.photos/seed/labelvie/400/200',
      Color(0xFFF9A825),
      'En 60 minutes',
      false,
    ),
    _Store(
      'BIM Maroc',
      '\u{1F6CD}\uFE0F',
      'https://picsum.photos/seed/bim/400/200',
      Color(0xFFB71C1C),
      'En 60 minutes',
      false,
    ),
    _Store(
      'Atacadão',
      '\u{1F4E6}',
      'https://picsum.photos/seed/atacadao/400/200',
      Color(0xFFE53935),
      'En 60 minutes',
      false,
    ),
    _Store(
      'Souk Express',
      '\u{1F966}',
      'https://picsum.photos/seed/soukexpress/400/200',
      Color(0xFFD32F2F),
        ...
        child: Stack(
          ...
          children: [
            ...
            Image.network(
              store.imageUrl,
              fit: BoxFit.cover,
              errorBuilder: (_, _, _) => Container(color: store.color),
            ),
