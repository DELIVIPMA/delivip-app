...
class _RestaurantDetailsScreenState extends State<RestaurantDetailsScreen> {
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildTextItem(
                      'Bouteille Eau Min\u00E9rale Pliny',
                      '20.00 DH',
                      subtitle: 'Doit avoir 18 ans pour acheter',
                    ),
    ...
    return SizedBox(
      ...
      child: Stack(
        children: [
          ...
          Container(
            height: 220,
            decoration: const BoxDecoration(color: Color(0xFFE8F0E9)),
  ...
  Widget _buildPopularSection() {
    return _buildMenuSection('Les plus populaires', [
      _MenuItem(
  ...
  Widget _buildSelectedForYou() {
    return _buildMenuSection('S\u00E9lectionn\u00E9s pour vous', [
      _MenuItem(
        name: 'Pizza Anniversaire',
        price: '80.00 DH',
        desc:
            'Pepperoni, marinara, mozzarella, ail et huile d\u2019olive extra',
        emoji: null,
      ),
      _MenuItem(
        ...
        price: '55.00 DH',
        desc:
            'Petits l\u00E9gumes, vinaigrette vegan maison, cro\u00FBtons, levure nutritionnelle, c\u00E2pres',
        emoji: null,
      ),
      _MenuItem(
        ...
        price: '35.00 DH',
        desc:
            'Roquette, fenouil shav\u00E9, vinaigre et huile d\u2019olive, pecorino et amandes',
        emoji: null,
      ),
      _MenuItem(
