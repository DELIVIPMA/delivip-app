  ...
  static const List<ProductSection> _sections = [
    ...
    ProductSection(
      ...
      items: [
        Product(
          emoji: '\u{1FAD6}',
          name: 'Th\u00E9 Chai Curcuma',
          price: '13.50 DH',
          unit: '16 sachets',
        ),
        Product(
          emoji: '\u{1F36B}',
          name: 'Chocolat Sans Sucre',
          price: '13.50 DH',
          unit: '200g',
        ),
        Product(
    ...
    ProductSection(
      ...
      items: [
        Product(
          emoji: '\u{1F33D}',
          name: 'Chips Nacho Fromage',
          price: '15.25 DH',
          unit: '250g',
        ),
        Product(
          emoji: '\u{1F33E}',
          name: 'Crackers Tomate',
          price: '13.50 DH',
          unit: '200g',
        ),
        Product(
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Product sections
                    ..._sections.map(
                      (section) => _buildProductSection(section),
                    ),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        image: const DecorationImage(
          image: NetworkImage(
            'https://picsum.photos/seed/marjane-express/800/300',
          ),
          fit: BoxFit.cover,
        ),
      ),
